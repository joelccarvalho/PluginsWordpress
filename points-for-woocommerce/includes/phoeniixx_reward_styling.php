			...
			<table class="form-table" style="width:50%;">
				...
				<tr>
					...
					<td>
						...
						<input class="btn_color_picker btn_bg_col" type="text" name="apply_btn_bg_col" value="<?php echo(isset($gen_settings['apply_btn_bg_col'])) ?$gen_settings['apply_btn_bg_col']:'#fff';?>">
